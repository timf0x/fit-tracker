...
export function DayContentCard({ day, onPressSession, onStartSession }: DayContentCardProps) {
  ...
  // ─── Past trained day ───
  if (day.isPast && day.sessions.length > 0) {
        ...
        <View style={styles.headerRow}>
          ...
          {day.prs > 0 && (
            <View style={styles.prBadge}>
              ...
              <Text style={styles.prText}>{day.prs}</Text>
            </View>
          )}
  ...
  if (day.isToday && day.programDay) {
    ...
    const readiness = day.recoveryProjection?.overallReadiness || 100;
          ...
          <View style={styles.readinessBarBg}>
            <View
              style={[
                ...
                readiness < 60 && styles.readinessBarLow,
              ]}
            />
          </View>
          <Text style={styles.readinessText}>
            {i18n.t('calendar.readinessLabel', { pct: readiness })}
          </Text>
        </View>
      ...
      <View style={styles.card}>
        <View style={styles.headerRow}>
          ...
          <View style={styles.headerContent}>
            <Text style={styles.title}>{label}</Text>
            <Text style={styles.meta}>
              {day.programDay.muscleTargets.slice(0, 3).join(', ')}
            </Text>
          </View>
        </View>
