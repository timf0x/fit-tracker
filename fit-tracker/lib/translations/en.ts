export default {
  ...
  settings: {
    ...
    profileEquipmentDetail: 'Customize your available equipment',
    profileEquipmentAlwaysOn: 'always on',
  ...
  readiness: {
    ...
    levelLow: 'Fatigued',
    nudgePeak: 'Push your limits!',
    nudgeGood: 'Normal session.',
    nudgeModerate: 'Session auto-adjusted.',
    nudgeLow: 'Very light session.',
  ...
  calendarLog: {
    ...
    namePlaceholder: 'e.g. Chest + Triceps',
    duration: 'Duration',
  ...
  auth: {
    ...
    signUpSubtitle: 'Back up your data in the cloud',
    usernameLabel: 'Username',
    usernamePlaceholder: 'your_name',
    usernameHint: 'Your unique @handle — letters, numbers and _',
    ...
    signInSubtitle: 'Sign in to recover your data',
    ...
    signOutConfirmMsg: 'Your local data will be kept. You can sign back in anytime.',
  },

  // ─── Profile Setup (Post-Signup Onboarding) ───
  profileSetup: {
    // Step 1: Identity
    identityTitle: 'Welcome',
    identitySubtitle: 'Get to know your app',
    nameLabel: 'First name',
    namePlaceholder: 'Thomas',
    nameHint: "This is how the app will greet you",
    emailConfirm: 'Account created with %{email}',
    heyPreview: 'Hey, %{name}',
    // Step 2: Body
    bodyTitle: 'Your body',
    bodySubtitle: 'To estimate your weights and calibrate your training volume',
    sexLabel: 'Sex',
    male: 'Male',
    female: 'Female',
    weightLabel: 'Weight',
    ...
    // Step 3: Experience
    experienceTitle: 'Your level',
    experienceSubtitle: 'To adapt volume and difficulty',
    beginner: 'Beginner',
    beginnerDesc: 'Less than 1 year training',
    intermediate: 'Intermediate',
    intermediateDesc: '1 to 3 years consistent',
    advanced: 'Advanced',
    advancedDesc: '3+ years serious',
    trainingYearsLabel: 'Training years',
    // Step 4: Week catch-up
    weekTitle: 'Your week',
    weekSubtitle: "Did you already train this week? The app will have data from the start.",
    restDay: 'Rest',
    duration: 'Duration',
    intensity: 'Intensity',
    light: 'Light',
    ...
    phoneHint: 'Optional — to find your friends later',
    ...
    // Step 4
    tapToLog: 'Tap a day to log your session',
    loggedSessions: '%{count} session(s) logged',
    noSessionsYet: 'No sessions this week',
    // Avatar
    addPhoto: 'Add a photo',
    // Step 3b: Training setup
    goalTitle: 'Your goal',
    goalSubtitle: 'To adapt your program and recommendations',
    goalHypertrophy: 'Hypertrophy',
    goalHypertrophyDesc: 'Build muscle, optimal volume',
    goalStrength: 'Strength',
    goalStrengthDesc: 'Lift heavier, high intensity',
    goalRecomp: 'Recomposition',
    goalRecompDesc: 'Lose fat and gain muscle',
    equipmentTitle: 'Your equipment',
    equipmentSubtitle: 'To pick the right exercises',
    equipmentFullGym: 'Full gym',
    equipmentFullGymDesc: 'Barbells, machines, cables, dumbbells',
    equipmentHomeDumbbell: 'Home + dumbbells',
    equipmentHomeDumbbellDesc: 'Dumbbells, bands, bench',
    equipmentBodyweight: 'Bodyweight',
    equipmentBodyweightDesc: 'No equipment, floor exercises',
    daysPerWeekTitle: 'Days per week',
    daysPerWeekSubtitle: 'How many sessions per week?',
    // Nav
    skip: 'Skip',
    next: 'Continue',
    finish: "Let's go",
  ...
  onboarding: {
    slide1Title: 'Your muscles, mapped',
    slide1Subtitle: 'Visualize every muscle group and its recovery status',
    slide2Title: 'Train in the zone',
    slide2Subtitle: 'Optimal volume per muscle — based on hypertrophy science',
    slide3Title: 'Progress every session',
    slide3Subtitle: 'Smart progressive overload and automatic personal records',
    slide4Title: 'Recover smarter',
    slide4Subtitle: 'Fatigue score, deload detection and optimal frequency',
    continue: 'Continue',
